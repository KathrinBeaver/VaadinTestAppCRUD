package ru.mai.pvk.VaadinTest.bookstore.ui;
...
import ru.mai.pvk.VaadinTest.bookstore.ui.about.AboutView;
import ru.mai.pvk.VaadinTest.bookstore.ui.inventory.InventoryView;
...
public class MainLayout extends AppLayout implements RouterLayout {
    ...
    public MainLayout() {
        ...
        final Label title = new Label("Книжный магазин");
        top.add(image, title);
        top.add(title);
        addToNavbar(top);
