package ru.mai.pvk.VaadinTest.bookstore.backend.mock;
...
import ru.mai.pvk.VaadinTest.bookstore.backend.data.Availability;
import ru.mai.pvk.VaadinTest.bookstore.backend.data.Category;
